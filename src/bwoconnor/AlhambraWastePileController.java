...
public class AlhambraWastePileController extends SolitaireReleasedAdapter {

	PileView src;

	public AlhambraWastePileController(Alhambra theGame, PileView src) {
		super(theGame);
		this.src = src;
	...
	public void mousePressed(MouseEvent me) {
		...
		if (w != Container.getNothingBeingDragged()) {
			System.err
					.println("WastePileController::mousePressed(): Unexpectedly encountered a Dragging Object during a Mouse press.");
			return;
		}
	...
	public void mouseReleased(MouseEvent me) {
		...
		Move move = new ReserveToWasteMove(srcPile, theCard, foundation);
